...
<body>
    <div class="container">
        <h2>Sửa sản phẩm</h2>
        <form action="{{ route('product.update'), $pros->item }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-check">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="status" id="status" value="1">Hiển Thị
                </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <textarea name="description" id="description" cols="148" rows="3" placeholder="Mô tả..."></textarea>
            </div>
